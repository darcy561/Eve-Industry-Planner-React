...
export default function Step5JobCard({
  job,
            ...
            <Grid container item xs={9}>
              <Grid container item xs={12}>
                ...
                <Grid item xs={4}>
                  ...
                  >
                    {job.isSnapshot ? job.linkedOrdersCount.toLocaleString() : job.build.sale.marketOrders.length.toLocaleString()}
                  </Typography>
                </Grid>
              </Grid>
              <Grid container item xs={12}>
                ...
                <Grid item xs={2}>
                  <Typography
                    ...
                    sx={{ paddingRight: { sm: "20px" } }}
                  >
                    {job.isSnapshot ? job.linkedTransCount.toLocaleString() : job.build.sale.transactions.length.toLocaleString()}
                  </Typography>
                </Grid>
              </Grid>
            </Grid>
