export let jobArrayDefault = [
  ...
  },
  {
    ...
    apiOrders: new Set([6161413749]),
    apiTransactions: new Set([
      5225763813, 5763860401, 5763883247, 5763890268, 5763852213,
    ]),
    parentJob: [],
    skills: [
      {
        ...
        marketOrders: [
          {
            ...
            volume_remain: 0,
            volume_total: 50,
            timeStamps: ["2021-12-30T18:33:45Z"],
            CharacterHash: "ABC123",
            complete: true,
          },
        ],
...
export let userJobSnapshotDefault = [
  ...
  },
  {
    ...
    parentJob: [1642710724535],
    childJobs: [],
    materialIDs: [4247, 39, 30373, 30375],
    metaLevel: null,
    projectID: null,
    endDataDisplay: null,
  },
  {
    ...
    parentJob: [1642710724535],
    childJobs: [],
    materialIDs: [4051, 30375, 30376, 38],
    metaLevel: null,
    projectID: null,
    endDataDisplay: null,
  },
  {
    ...
    isSnapshot: false,
    apiJobs: [477723892],
    apiOrders: [6161413749],
    apiTransactions: [5225763813, 5763860401, 5763883247, 5763890268],
    itemQuantity: 50,
    totalMaterials: 4,
    totalComplete: 4,
    buildVer: "0.6.0",
  ...
  },
  {
    ...
    buildVer: "0.6.0",
    parentJob: [],
    childJobs: [1642710994021, 1642711045845],
    materialIDs: [30305, 30019, 30308, 30021, 30022, 30309, 30254],
    projectID: null,
    endDateDisplay: null,
  },
];
...
export let defaultEsiSkills = [
  ...
  { name: "Broker Relations", id: 3446, activeLevel: 5 },
  {
    id: 11454,
