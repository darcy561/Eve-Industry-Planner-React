...
export function useManageGroupJobs() {
  ...
  function findJobIDOfMaterialFromGroup(requestedMaterialID, requestedGroupID) {
    ...
    if (!requestedGroupObject.includedTypeIDs.includes(requestedMaterialID))
      return null;
  ...
  return {
    addJobToGroup,
    addMultipleJobsToGroup,
    findJobIDOfMaterialFromGroup,
    removeJobFromGroup,
  };
}
